...
*/
	...
	protected MenuManager createMenuManager() {
		...
		MenuManager formatMenuManager = new MenuManager("格式");
		MenuManager fontNameMenuManager = new MenuManager("字体");
		// 创建【字体】菜单的子菜单
		createFontNameMenu(fontNameMenuManager);
		// 向【格式】菜单添加【字体】菜单项
		formatMenuManager.add(fontNameMenuManager);

		MenuManager fontSizeMenuManager = new MenuManager("字号");
		// 创建【字号】菜单的子菜单
		createFontSizeMenu(fontSizeMenuManager);
		// 向【格式】菜单添加【字号】菜单项
		formatMenuManager.add(fontSizeMenuManager);

		// 向【格式】菜单添加【粗体】菜单项		
		formatMenuManager.add(new TaFontBoldAction());
		// 向【格式】菜单添加【斜体】菜单项		
		formatMenuManager.add(new TaFontItalicAction());
		
		menuManager.add(fileMenuManager);
		menuManager.add(formatMenuManager);
		return menuManager;
	}
	...
	public static void main(String args[]) {
		try {
			JFileReader window = new JFileReader();
